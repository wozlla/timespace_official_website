            ...
            fs.readFile(
                ...
                function(e, data){
                    ...
                    expect(json[filePath][0]).toEqual(
                        { command : 'replace', dist : '../dist/no_cmd.js', fileUrlArr : [ '../pulic/js/bower_components/jquery/dist/jquery.js', '../pulic/js/bower_components/bootstrap/dist/js/bootstrap.min.js', '../pulic/js/bower_components/seajs/dist/sea.js', '../pulic/js/bower_components/seajs-wrap/dist/seajs-wrap.js', '../pulic/js/website/global.js', '../pulic/js/website/animation.js', '../pulic/js/website/nav.js' ], startLine : 167, endLine : 742 }
                    );
